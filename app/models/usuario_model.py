...
class UsuarioModel(Base):
    ...
    sexo = Column(String, nullable=False)  # Enum para o campo sexo
    ...
    escolaridade = Column(String, nullable=False)  # Enum para o campo escolaridade
    racaCor = Column(String, nullable=False)  # Enum para o campo racaCor
    faixaEtaria = Column(String, nullable=False)  # Enum para o campo faixaEtaria
    estadoCivil = Column(String, nullable=False)  # Enum para o campo estadoCivil
    ...
    grupo = Column(String, nullable=False)  # Enum para o campo grupo
